...
namespace FromLocalsToLocals.Utilities
{
    ...
    {
        public static string htmlCodeForEmails =
            "<!DOCTYPE html><html><head></head><body style=\"background-color: #CCBA8B;\">" +
        ...
        public static async Task NewsLetterSender(string msge, string email)
        {
            ...
            var htmlContent =
                htmlCodeForEmails + "</td></tr><tr><td class=\"content\"><b><div style=\"text-align: center;\">"
